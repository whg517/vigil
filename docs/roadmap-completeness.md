...
> **注**：任务提示所称「T5.5 raw_event 重放」对应本文 roadmap 的 **T5.3**（M12），前轮已落地。roadmap 原 T5.5（IM 绑定自助/解绑）不在范围。M5 尚余 **T5.4**（IM 平台补全）、**T5.5**（IM 绑定）未做。**T5.3 Runbook trigger 求值**（B13，独立于 M12 RawEvent 重放）本轮落地——见上表末行。
