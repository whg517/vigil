...
const (
	...
	TypeNoiseSuggestion    Type = "noise_suggestion"
)
...
func TypeValidator(_type Type) error {
	switch _type {
	case TypeDedupSuggestion, TypeSeverityAdjustment, TypeRootCauseHint, TypeSimilarIncident, TypeDraftSummary, TypePostmortemDraft, TypeRunbookSuggestion, TypeNoiseSuggestion:
		return nil
	default:
