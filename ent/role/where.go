...
func ScopeLevelEQ(v ScopeLevel) predicate.Role {
	return predicate.Role(sql.FieldEQ(FieldScopeLevel, v))
}

// ScopeLevelNEQ applies the NEQ predicate on the "scope_level" field.
func ScopeLevelNEQ(v ScopeLevel) predicate.Role {
	return predicate.Role(sql.FieldNEQ(FieldScopeLevel, v))
}

// ScopeLevelIn applies the In predicate on the "scope_level" field.
func ScopeLevelIn(vs ...ScopeLevel) predicate.Role {
	return predicate.Role(sql.FieldIn(FieldScopeLevel, vs...))
}

// ScopeLevelNotIn applies the NotIn predicate on the "scope_level" field.
func ScopeLevelNotIn(vs ...ScopeLevel) predicate.Role {
	return predicate.Role(sql.FieldNotIn(FieldScopeLevel, vs...))
}
...
func HasRoleBindings() predicate.Role {
...
func HasRoleBindingsWith(preds ...predicate.RoleBinding) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
