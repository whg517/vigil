...
func (_u *APIKeyUpdate) SetTokenHash(v string) *APIKeyUpdate {
	_u.mutation.SetTokenHash(v)
	return _u
}

// SetNillableTokenHash sets the "token_hash" field if the given value is not nil.
func (_u *APIKeyUpdate) SetNillableTokenHash(v *string) *APIKeyUpdate {
	if v != nil {
		_u.SetTokenHash(*v)
	}
	return _u
...
func (_u *APIKeyUpdate) SetScope(v []string) *APIKeyUpdate {
	_u.mutation.SetScope(v)
	return _u
}

// AppendScope appends value to the "scope" field.
func (_u *APIKeyUpdate) AppendScope(v []string) *APIKeyUpdate {
	_u.mutation.AppendScope(v)
	return _u
}

// ClearScope clears the value of the "scope" field.
func (_u *APIKeyUpdate) ClearScope() *APIKeyUpdate {
...
func (_u *APIKeyUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.AppendedScope(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, apikey.FieldScope, value)
		})
	}
	if _u.mutation.ScopeCleared() {
		_spec.ClearField(apikey.FieldScope, field.TypeJSON)
	}
...
// SetTokenHash sets the "token_hash" field.
func (_u *APIKeyUpdateOne) SetTokenHash(v string) *APIKeyUpdateOne {
	_u.mutation.SetTokenHash(v)
	return _u
}

// SetNillableTokenHash sets the "token_hash" field if the given value is not nil.
func (_u *APIKeyUpdateOne) SetNillableTokenHash(v *string) *APIKeyUpdateOne {
	if v != nil {
		_u.SetTokenHash(*v)
	}
	return _u
...
// SetScope sets the "scope" field.
func (_u *APIKeyUpdateOne) SetScope(v []string) *APIKeyUpdateOne {
	_u.mutation.SetScope(v)
	return _u
}

// AppendScope appends value to the "scope" field.
func (_u *APIKeyUpdateOne) AppendScope(v []string) *APIKeyUpdateOne {
	_u.mutation.AppendScope(v)
	return _u
}

// ClearScope clears the value of the "scope" field.
func (_u *APIKeyUpdateOne) ClearScope() *APIKeyUpdateOne {
	_u.mutation.ClearScope()
	return _u
}
