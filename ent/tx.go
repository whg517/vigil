...
func (tx *Tx) init() {
	...
	tx.MetricsSnapshot = NewMetricsSnapshotClient(tx.config)
	...
	tx.Rotation = NewRotationClient(tx.config)
...
// applies a query, for example: AIInsight.QueryXXX(), the query will be executed
